                ...
                <div class="card">
                    <div class="card-body">
                        <div class="card-title pb-0">
                            <div class="mb-0">
                                <a class="btn btn-primary btn-sm" href="{{ route('vehiculo.create') }}"><i
                                    ...
                                    <tr>
                                        ...
                                        <td class="py-1 align-middle text-center">
                                            <div class="btn-group btn-group-sm">
                                                <a href="{{ route('vehiculo.edit', $item->id) }}" class="btn btn-info"
