                ...
                <div class="card">
                    <div class="card-body">
                        <div class="card-title pb-0">
                            <div class="mb-0">
                                <a class="btn btn-primary btn-sm" href="{{ route('proveedor.create') }}"><i
                                    ...
                                    <tr>
                                        ...
                                        <td class="py-1 align-middle text-center">
                                            <div class="btn-group btn-group-sm">
                                                <a href="{{ route('proveedor.edit', $item->id) }}" class="btn btn-info"
                                                    rel="tooltip" data-placement="top" title="Editar"><i
                                                        class="bi bi-pencil-square"></i></a>
                                                <a href="#" class="btn btn-danger" rel="tooltip"
                                                    data-placement="top" title="Eliminar"
                                                    data-href="{{ route('proveedor.destroy', $item->id) }}"
