    ...
    <div class="pagetitle">
        ...
        <nav>
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">Crear Turno</li>
            </ol>
        </nav>
    </div><!-- End Page Title -->
            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <!-- Multi Columns Form -->
                        <form class="row g-3 mt-0" method="POST" action="{{ route('turno.store') }}">
                            @csrf
                            <div class="col-md-6">
                                <label for="descripcion" class="form-label">Descripción Turno</label>
                                <input type="datetime" class="form-control" id="descripcion" name="descripcion"
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="datetime-local" class="form-control" id="inicio_turno" name="inicio_turno" value="{{ old('inicio_turno') }}" required>
                                @error('inicio_turno')
                                    <div class="text-danger small">
                                        {{ $message }}
                                    </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="datetime-local" class="form-control" id="fin_turno" name="fin_turno" value="{{ old('fin_turno') }}" required>
                                @error('fin_turno')
                                    <div class="text-danger small">
                                        {{ $message }}
                                    </div>
